...
We're looking for people to come and help work on the latest challenge **Coinbee**.
...
## The Challenges
### Easy 🙂
##### 🚀 [Rocket Ship](https://github.com/Alpinist-Denis/react-coding-challenges/tree/master/rocket-ship)
Unnecessary re-renders, fine grained control.

&nbsp;
### Medium 😐
##### 🌙 [Dark Mode](https://github.com/Alpinist-Denis/react-coding-challenges/tree/master/dark-mode)
...
&nbsp;
### Hard 😬
##### 🎧 [Spootify](https://github.com/Alpinist-Denis/react-coding-challenges/tree/master/spootify)
Loading state, API usage.

##### 🤖 [Chatter](https://github.com/Alpinist-Denis/react-coding-challenges/tree/master/chatter)
...
&nbsp;
## Contributing 💡
We have an [issue template](https://github.com/Alpinist-Denis/react-coding-challenges/blob/master/issue_template.md), [pull request template](https://github.com/Alpinist-Denis/react-coding-challenges/blob/master/pull_request_template.md) and a [new challenge template](https://github.com/Alpinist-Denis/react-coding-challenges/blob/master/new_challenge_template.md). We encourage you to fill out the right template and open a PR / issue!
